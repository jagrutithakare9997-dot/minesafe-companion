...
import { Shield, AlertTriangle, Radio, BarChart3 } from "lucide-react";
...
type Screen = "sos" | "hazard" | "fall" | "command";

export interface Alert {
  id: string;
  type: "sos" | "hazard" | "fall";
  message: string;
  location: string;
  timestamp: Date;
...
const Index = () => {
  ...
  // Simulate fall detection with device motion
  useEffect(() => {
  ...
  const navItems: { key: Screen; icon: typeof Shield; label: string }[] = [
    ...
    { key: "command", icon: BarChart3, label: "Center" },
  ];
